...
export function DashboardCards() {
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card className="overflow-hidden bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow duration-200 w-full md:w-auto">
        <CardHeader className="bg-white dark:bg-gray-900">
          <CardTitle className="text-lg md:text-xl text-gray-900 dark:text-gray-100">
            Payments to Receive
          </CardTitle>
          <CardDescription className="text-gray-500 dark:text-gray-400 hidden md:block">
            Amount owed to you
          </CardDescription>
        </CardHeader>
